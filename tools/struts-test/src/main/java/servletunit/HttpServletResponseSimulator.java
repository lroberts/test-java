...
public class HttpServletResponseSimulator implements HttpServletResponse
{
	...
	if(getHeaderNames().contains(name)){
    ...
    */
     ...
     * an RuntimeException with the corresponding error
     * number.
     *
    ...
    {
        setStatus(sc);
        throw new RuntimeException("received error: " + sc);
    }
    ...
    {
        setStatus(sc,msg);
        throw new RuntimeException("received error " + sc + " : " + msg);
    }
