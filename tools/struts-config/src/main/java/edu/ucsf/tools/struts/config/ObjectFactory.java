 ...
 * generated in the edu.ucsf.tools.struts.config package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: edu.ucsf.tools.struts.config
     * 
     */
