<?php
//  July 21, 2009 05:30:40 PM

$view = new view;
$view->name = 'volunteer_opportunities_calendar';
$view->description = 'Volunteer Opportunities: A multi-dimensional calendar view with back/next navigation.';
$view->tag = 'Calendar';
$view->view_php = '';
...
$handler->override_option('title', 'Volunteer Opportunities');
...
$handler->override_option('path', 'volunteer-opportunities');
$handler->override_option('menu', array(
  'type' => 'normal',
  'title' => 'Volunteer Oopportunities',
  'description' => '',
  'weight' => '2',
  'name' => 'primary-links',
));
...
$handler->override_option('block_description', 'Volunteer Opportunities');
...
$handler->override_option('block_description', 'Upcoming (Volunteer Opportunities)');
$handler->override_option('block_caching', -1);
