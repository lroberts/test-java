<?php
//  July 21, 2009 05:29:13 PM

$view = new view;
$view->name = 'community_social_events_calendar';
$view->description = 'Community & Social Events: A multi-dimensional calendar view with back/next navigation.';
$view->tag = 'Calendar';
$view->view_php = '';
...
$handler->override_option('title', 'Community & Social Events');
...
$handler->override_option('path', 'community-social-events');
...
$handler->override_option('block_description', 'Community & Social Events');
...
$handler->override_option('block_description', 'Upcoming (Community & Social Events)');
$handler->override_option('block_caching', -1);
