<?php
//  July 21, 2009 05:28:14 PM

$view = new view;
$view->name = 'academic_calendar';
$view->description = 'Academic Calendar: A multi-dimensional calendar view with back/next navigation.';
$view->tag = 'Calendar';
$view->view_php = '';
...
$handler->override_option('title', 'Academic Calendar');
...
$handler->override_option('path', 'academic-calendar');
...
$handler->override_option('block_description', 'Academic Calendar');
...
$handler->override_option('block_description', 'Upcoming (Academic Calendar)');
$handler->override_option('block_caching', -1);
