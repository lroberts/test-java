<?php
// June 05, 2009 01:39:19 PM

$view = new view;
$view->name = 'quick_links_sub';
$view->description = 'Quick Links for sub-pages';
$view->tag = '';
$view->view_php = '';
...
$handler->override_option('block_description', 'Quick Links - sub-pages');
