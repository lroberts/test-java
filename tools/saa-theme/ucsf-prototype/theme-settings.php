...
function phptemplate_settings($saved_settings) {
  ...
  $js = <<<SCRIPT
    jQuery(document).ready(function(){
      jQuery("fieldset.general_settings > legend > a").click(function(){
        if(!jQuery("fieldset.node_settings").hasClass("collapsed")) {
          Drupal.toggleFieldset(jQuery("fieldset.node_settings"));
        }
      });
      jQuery("fieldset.node_settings > legend > a").click(function(){
        if (!jQuery("fieldset.general_settings").hasClass("collapsed")) {
          Drupal.toggleFieldset(jQuery("fieldset.general_settings"));
        }
      });
    });
SCRIPT;
  ...
  $form['tnt_container'] = array(
    '#type' => 'fieldset',
    '#title' => t('UCSF base theme settings'),
