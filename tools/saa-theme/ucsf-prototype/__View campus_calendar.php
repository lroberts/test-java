<?php
//  July 21, 2009 05:28:48 PM

$view = new view;
$view->name = 'campus_calendar';
$view->description = 'Campus Calendar: A multi-dimensional calendar view with back/next navigation.';
$view->tag = 'Calendar';
$view->view_php = '';
...
$handler->override_option('title', 'Campus Calendar');
...
$handler->override_option('path', 'campus-calendar');
...
$handler->override_option('block_description', 'Campus Calendar');
...
$handler->override_option('block_description', 'Upcoming (Campus Calendar)');
$handler->override_option('block_caching', -1);
