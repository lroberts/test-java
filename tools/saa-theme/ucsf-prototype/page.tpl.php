...
<!--
  <link rel="stylesheet" href="http://test3.larry.ucsf.edu/sites/all/themes/ucsf_rco/ucla-mwf-3c9159a/root/assets/css/default/basic.css" type="text/css" />


  <link rel="stylesheet" href="http://test3.larry.ucsf.edu/sites/all/themes/ucsf_rco/ucla-mwf-3c9159a/root/assets/css/default/full.css" type="text/css" />

  <link rel="stylesheet" href="http://test3.larry.ucsf.edu/sites/all/themes/ucsf_rco/ucla-mwf-3c9159a/root/assets/css.php" type="text/css" />

  <script type="text/javascript" src="http://test3.larry.ucsf.edu/sites/all/themes/ucsf_rco/ucla-mwf-3c9159a/root/assets/js.php?webkit_libs=transitions" ></script>

  <script type="text/javascript" href="http://test3.larry.ucsf.edu/sites/all/themes/ucsf_rco/ucla-mwf-3c9159a/root/assets/js/full/transitions.src.js" ></script>
-->
    ...
    <div id="ui-wrapper">
      <div id="ui-content-main">
        <div class="ui-content">
            ...
            <div id="ui-tools">
              <a class="toolFontSize" href="javascript:void(0);">Change font size</a>
...
?>
            ...
            <?php    if ($messages): ?>
              ...
              <?php    print $messages; ?>
              <a class="closeThis" href="javascript:void(0);" title="Close">Close</a>
              </div>
            <?php    endif; ?>
...
<div id="ui-footer" class="site-width">
  <div class="ui-content clear-block">
    ...
    <div id="footer-icons">
      ...
      <script type="text/javascript">var addthis_config = {username: 'ucsfsaa',data_use_flash: false};var addthis_options = 'delicious, digg, facebook, favorites, google, linkedin, live, myspace, stumbleupon, technorati, twitter, yahoobkm, more';</script>
      <script type="text/javascript" src="http://s7.addthis.com/js/200/addthis_widget.js"></script>
      <?php    print $feed_icons; ?>
    </div>

    <div id="ui-footer-msg" class="clear-block">
      <p id="c"><?php print '&copy; ' . date("Y") . ' ' . t('The Regents of the University of California'); ?>
			<?php if ($_SERVER['HTTP_HOST'] != 'registrar.ucsf.edu'): print ' | ' . l('Website Credits', 'http://www.project6.com/', array('query' => 'source=' . $_SERVER['HTTP_HOST'])); endif; ?></p>
