...
Drupal.tableDrag = function(table, tableSettings) {
  ...
  if (this.indentEnabled) {
    ...
    var testCell = jQuery('> tbody > tr.draggable:first td:first, > tr.draggable:first td:first', table).prepend(indent).prepend(indent);
  ...
  // Match immediate children of the parent element to allow nesting.
  jQuery('> tr.draggable, > tbody > tr.draggable', table).each(function() { self.makeDraggable(this); });
...
Drupal.tableDrag.prototype.hideColumns = function(){
  for (var group in this.tableSettings) {
    ...
    if (hidden && cell[0] && cell.css('display') != 'none') {
      ...
      jQuery('> thead > tr, > tbody > tr, > tr', this.table).each(function(){
        var row = jQuery(this);
...
Drupal.tableDrag.prototype.makeDraggable = function(item) {
  ...
  // Create the handle.
  var handle = jQuery('<a href="#" class="tabledrag-handle"><div class="handle">&nbsp;</div></a>').attr('title', Drupal.t('Drag to re-order'));
...
Drupal.tableDrag.prototype.restripeTable = function() {
  ...
  // Match immediate children of the parent element to allow nesting.
  jQuery('> tbody > tr.draggable, > tr.draggable', this.table)
